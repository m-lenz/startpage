const NAME = "M.";
const WELCOME_MESSAGE_TEMPLATE = ["night", "moin", "afternoon", "evening"];
...
const MASTER_MAP = [
    {
        "groupName": "wörk",
        "items":[
            {"name": "mail", "shortcutKey": "q", "url": "https://mailde.ardianet.com"},        
            {"name": "hawk", "shortcutKey": "r", "url": "http://65.52.133.94:8080"},
            {"name": "time", "shortcutKey": "w", "url": "https://portal.assystem-germany.com/hcmInside/cockpits/"},
            {"name": "confluence", "shortcutKey": "e", "url": "https://confluence.idial.institute"}
        ]
    },
    {
        "groupName": "git",
        "items":[
            {"name": "vehicle", "shortcutKey": "a", "url" : "https://github.com/eclipse/kuksa.invehicle"},
            {"name": "cloud", "shortcutKey": "s", "url" : "https://github.com/eclipse/kuksa.cloud"},
            {"name": "apps", "shortcutKey": "d", "url" : "https://github.com/eclipse/kuksa.apps"},
            {"name": "integration", "shortcutKey": "f", "url" : "https://github.com/eclipse/kuksa.integration"}
    ...
    },
    {
        "groupName": "personal",
        "items":[
            {"name": "intra", "shortcutKey": "z", "url": "https://portal.assystem-germany.com/intranet-de/"},
            {"name": "extra", "shortcutKey": "x", "url": "https://extranet.berner-mattner.com/SitePages/Home.aspx"},
            {"name": "yammer", "shortcutKey": "c", "url": "https://yammer.com/assystemtechnologies.com/"}
        ]
    }
]
...
function setupWelcomeMessage(){
    ...
    let welcome = " " + WELCOME_MESSAGE_TEMPLATE[curHours] + ", " + NAME;
